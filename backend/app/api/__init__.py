...
from . import filters, histogram, table, feature_groups, activation_examples, similarity_sort, cluster_candidates, cause, cold_start, consensus
...
router.include_router(cause.router, tags=["cause"])
