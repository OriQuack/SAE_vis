// ============================================================================
// CAUSE VISUALIZATION UTILITIES - Helper functions for CauseRadViz component
// ============================================================================
...
// Darker gray for untagged points (more visible than UNSURE_GRAY)
const CAUSE_UNTAGGED_COLOR = '#6b7280'
...
export function computeCategoryContours(
  ...
  const categories: Array<{ category: CauseCategory | 'unsure', color: string }> = [
    ...
    { category: 'unsure', color: CAUSE_UNTAGGED_COLOR }
  ]
